...
def mix_collate(batch):
    # each batch may have different number of samples
    # batch is a list of dictionaries
    # each dictionary contains the data for a single sample

    
    return [torch.utils.data._utils.collate.default_collate([x]) for x in batch]
